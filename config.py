...
STOCK_ID_MAPPING = {
    ...
    "NSLTECH": "NGNSLTECH006", "TRANSCORP": "NGTRANSCORP7", "UNITYBNK": "NGUNITYBANK3","INTBREW":"NGINTBREW005","ELLAHLAKES":"NGELLAHLAKE8"
}

# Auto-Refresh Configuration
REFRESH_INTERVAL_SECONDS = 15 * 60  # 15 minutes
GMT_OFFSET_FOR_REFRESH = 1
MARKET_OPEN_HOUR = 8
MARKET_CLOSE_HOUR = 18
MARKET_CLOSED_KEYWORDS = ["ENDOFDAY", "CLOSED", "MARKET_CLOSED"]
